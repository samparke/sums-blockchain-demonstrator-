        ...
        <nav className="bg-white fixed w-full z-20 top-0 start-0">
          ...
          />
            ...
            <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                ...
                <li>
                    <a href="/supply-chain" className="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Smart contracts</a>
                </li>
                <li>
