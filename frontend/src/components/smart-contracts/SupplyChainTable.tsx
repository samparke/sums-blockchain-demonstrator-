              ...
              <th className="py-3 px-6">
                <div className="flex items-center">
                  ...
                  <InfoPopover title="Sender">
                    The blockchain address that initiated this shipment - your
                    wallet address.
                  </InfoPopover>
                </div>
              </th>
              ...
              <th className="py-3 px-6">
                <div className="flex items-center">
                  ...
                  <InfoPopover title="Receiver">
                    The blockchain address that received the shipment - the
                    receiver address you input.
                  </InfoPopover>
                </div>
              </th>
              ...
              <th className="py-3 px-6">
                <div className="flex items-center">
                  ...
                  <InfoPopover title="Block #">
                    The block your transaction was confirmed within - this is
                    for the sepolia testnet chain.
                  </InfoPopover>
                </div>
              </th>
              ...
              <th className="py-3 px-6">
                <div className="flex items-center">
                  ...
                  <InfoPopover title="Blockchain Transaction">
                    The blockchain transaction hash - it is clickable to view it
                    on the public sepolia testnet chain.
                  </InfoPopover>
                </div>
              </th>
            ...
            {shipments.length > 0 ? (
              shipments.map((shipment, idx) => (
                <tr key={idx} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    {formatEther(BigInt(shipment.price))} ETH
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
