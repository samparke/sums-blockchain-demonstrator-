        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-gray-700">
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>
                This demo shows a simplified block, including the block number,
                nonce, data, hash and "Mine" button.
              </li>
              <br />
              <li>
                This is slightly more technical, but aim to grasp the overall
                concept.
              </li>
              <br />
              <li>
              ...
              <br />
              <li>
                To find such a hash, the system keeps changing the nonce and
                rehashing until it meets the requirements.
              </li>
              <br />
              <li>
                When a valid hash is found, the block is mined, and the miner
                (in a real blockchain) receives a reward.
              </li>
              <br />
              <li>
